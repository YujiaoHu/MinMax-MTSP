...
def print_solution(manager, routing, assignment):
    ...
    # print('Objective: {} miles'.format(assignment.ObjectiveValue()/100000))
    ...
    # # print(plan_output)
    # plan_output += 'Route distance: {}miles\n'.format(route_distance*1.0/100000)
    return assignment.ObjectiveValue()/100000
